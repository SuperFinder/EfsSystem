...
namespace EfsSystem
{
    public partial class FormLeaveOverInfoStatistics : Form
    {
        ...
        public FormLeaveOverInfoStatistics()
        {
            InitializeComponent();
        ...
        private void FormLeaveOverInfoStatistics_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = leaveOverInfoDao.getLeaveOverInfos(dateTimePicker1.Value, dateTimePicker2.Value, cmbUnitName.Text, cmbResponsibleUserName.Text, cmbServiceStyle.Text).Tables[0];
        }
